...
| <a name="input_healthcheck"></a> [healthcheck](#input\_healthcheck) | Healthcheck configuration | <pre>object({<br/>    path                = string<br/>    port                = optional(number)<br/>    inital_delay        = optional(number)<br/>    unhealthy_threshold = optional(number)<br/>    timeout             = optional(number)<br/>    interval            = optional(number)<br/>  })</pre> | <pre>{<br/>  "interval": 5,<br/>  "path": "/",<br/>  "timeout": 2,<br/>  "unhealthy_threshold": 3<br/>}</pre> | no |
| <a name="input_healthcheck_startup"></a> [healthcheck\_startup](#input\_healthcheck\_startup) | Startup probe configuration | <pre>object({<br/>    path                = string<br/>    port                = optional(number)<br/>    inital_delay        = optional(number)<br/>    unhealthy_threshold = optional(number)<br/>    timeout             = optional(number)<br/>    interval            = optional(number)<br/>  })</pre> | `null` | no |
